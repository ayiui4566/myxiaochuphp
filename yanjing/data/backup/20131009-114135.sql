...
--Create time：2013-10-09 11:41:35
DROP TABLE IF EXISTS `TAB_PREFIXadmins`;
CREATE TABLE `admins` (
...
DROP TABLE IF EXISTS `TAB_PREFIXcustomers`;
...
INSERT INTO `customers` VALUES ('6','三破','男','4','2013-10-06','发士大夫','实得分','23','','','','','','','','','','0','视远','45','2','','发送到发送到');
